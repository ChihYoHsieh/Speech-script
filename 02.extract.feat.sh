...
compute-cmvn-stats ark:$path/$target.39.ark ark,t:$path/$target.cmvn.ark 2>$log
apply-cmvn ark:$path/$target.cmvn.ark ark:$path/$target.39.ark ark,t:$path/$target.39.cmvn.ark 2> $log
